...
<p align="center">
  <img src="docs/assets/px4xplane-logo.svg" alt="PX4-XPlane logo" width="460">
</p>
...
The current package is `v4.1.2` with Windows, Linux, and macOS builds. It
...
`v4.1.2` includes the px4xplane-side fixes from the recent validation cycle:
