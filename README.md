...
The current package is `v4.0.7` with Windows, Linux, and macOS builds. It
...
2. Install or update PX4 SITL.
   Follow the official PX4 setup docs so your checkout is current enough to
   include X-Plane SITL:
   - [PX4 development environment](https://docs.px4.io/main/en/dev_setup/dev_env.html)
   - [PX4 X-Plane simulation](https://docs.px4.io/main/en/sim_xplane/)
...
`v4.0.7` includes the px4xplane-side fixes from the recent validation cycle:
